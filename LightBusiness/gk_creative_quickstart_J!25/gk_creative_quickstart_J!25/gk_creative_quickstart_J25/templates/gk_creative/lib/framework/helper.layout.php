...
class GKTemplateLayout {
	...
	public function generateLayoutWidths() {
		...
		$this->API->addCSSRule('#gkPageWrap, #gkPageNav > div, #gkTop1 > div, #gkBottom2 > div, #gkBottom3 > div, #gkBottom4 > div, .gkFooter, .gk-parallax > div { max-width: '.$template_width.'px; }' . "\n");
		// set body paddings
